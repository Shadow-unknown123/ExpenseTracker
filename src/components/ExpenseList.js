              ...
              <ul className="w-full flex justify-center items-center flex-col ">
                <li className="bg-[#494557] mt-6 w-[90%] md:w-[95%] 2xl:w-[98%] rounded-lg py-3 md:py-4 2xl:py-5 2xl:rounded-xl">
                  <div className="flex justify-evenly items-center">
                    <h1 className="text-center font-semibold rounded-xl bg-[#D8FBFF] w-20 md:text-lg md:py-2 md:min-w-44 lg:min-w-60 2xl:py-4">
                      Name
                    </h1>
                    <h1 className="text-center font-semibold rounded-xl bg-[#D8FBFF] w-20 md:text-lg md:py-2 md:min-w-44 lg:min-w-60 2xl:py-4">
                      Name
                    ...
                    <button className="bg-[#FFABAC] text-sm lg:text-base 2xl:text-lg px-2 rounded-xl border border-black font-semibold 2xl:font-bold md:py-1 md:px-4 2xl:py-2 2xl:px-7">
                      Remove
                    </button>
                  </div>
                </li>
